...
public final class AGreateqcComparison extends PComparison
{
    private PExpression _lexpr_;
    private PExpression _rexpr_;

    public AGreateqcComparison()
    {
    }
    ...
    public Object clone()
    {
        return new AGreateqcComparison(
    ...
    {
        ((Analysis) sw).caseAGreateqcComparison(this);
    }
