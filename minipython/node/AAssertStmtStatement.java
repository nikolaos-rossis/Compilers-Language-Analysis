...
public final class AAssertStmtStatement extends PStatement
{
    ...
    public Object clone()
    {
        return new AAssertStmtStatement(
    ...
    {
        ((Analysis) sw).caseAAssertStmtStatement(this);
    }
    ...
    private class RExpr_Cast implements Cast
    {
        public Object cast(Object o)
        {
            ...
            if((node.parent() != null) &&
                (node.parent() != AAssertStmtStatement.this))
            {
                node.parent().removeChild(node);
            }
