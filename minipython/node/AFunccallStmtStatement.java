...
public final class AFunccallStmtStatement extends PStatement
{
    private PFunctionCall _functionCall_;

    public AFunccallStmtStatement()
    {
    }
    ...
    public Object clone()
    {
        return new AFunccallStmtStatement(
            (PFunctionCall) cloneNode(_functionCall_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAFunccallStmtStatement(this);
    }
