...
public final class ADiveqStmtStatement extends PStatement
{
    private PExpression _lExpr_;
    private PExpression _rExpr_;

    public ADiveqStmtStatement()
    {
    }
    ...
    public Object clone()
    {
        return new ADiveqStmtStatement(
    ...
    {
        ((Analysis) sw).caseADiveqStmtStatement(this);
    }
