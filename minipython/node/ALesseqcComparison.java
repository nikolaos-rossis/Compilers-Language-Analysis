...
public final class ALesseqcComparison extends PComparison
{
    private PExpression _lexpr_;
    private PExpression _rexpr_;

    public ALesseqcComparison()
    {
    }
    ...
    {
        ((Analysis) sw).caseALesseqcComparison(this);
    }
